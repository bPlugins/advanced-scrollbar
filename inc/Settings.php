...
if( !class_exists('CASBScrollBarSettings') ){
	class CASBScrollBarSettings{
		public function __construct(){
			add_action( 'wp_ajax_casbScrollbarOptions', [$this, 'bPlSettingsOptions'] );
		...
		function bPlSettingsOptions(){
			...
			if( !wp_verify_nonce( $nonce, "casb_scrollbar_nc" ) ){
